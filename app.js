(function () {
  ...
  function resetForm() {
    FIELDS.forEach((field) => {
      document.getElementById(field.input).value = "0";
    });
    clearPrediction();
  }
  ...
  function clearPrediction() {
    ...
    document.querySelector(".meter-arc").style.setProperty("--score", "0%");
    document.getElementById("rangeFill").style.width = "0%";
    document.getElementById("predictionSummary").textContent = "Enter values and run prediction.";
    document.getElementById("confidenceBadge").textContent = "Waiting";
    document.getElementById("confidenceBadge").style.color = "var(--warn)";
    document.getElementById("rangeWarning").textContent = "";
    document.getElementById("matchesBody").innerHTML = "";
    document.getElementById("contributionCards").innerHTML = "";
  }
